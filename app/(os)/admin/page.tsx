    ...
    <div className="p-6">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Sync Xero Payments */}
          <button
            className="flex flex-col items-center justify-center p-6 bg-white border border-gray-200 rounded-lg hover:border-purple-300 hover:shadow-md transition-all opacity-50 cursor-not-allowed"
            disabled
          >
            <svg
            ...
            <span className="text-sm font-medium text-gray-900">Sync Xero Payments</span>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900">Run Maintenance</span>
            <span className="text-xs text-gray-500 mt-1">Daily cleanup tasks</span>
          </button>

          {/* View Error Log */}
          <Link
            href="/staff/admin/errors"
            className="flex flex-col items-center justify-center p-6 bg-white border border-gray-200 rounded-lg hover:border-purple-300 hover:shadow-md transition-all"
          >
            <svg
            ...
            <span className="text-sm font-medium text-gray-900">View Error Log</span>
            <span className="text-xs text-gray-500 mt-1">System errors</span>
          </Link>
          ...
          <div className="flex flex-col items-center justify-center p-6 bg-white border border-gray-200 rounded-lg">
            ...
            <span className="text-xs text-green-600 mt-1">All systems operational</span>
          </div>
        </div>
      </div>
